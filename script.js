...
function showError(error) {
  ...
  switch(error.code) {
    ...
    case error.POSITION_UNAVAILABLE:
      ...
      break;
    case error.TIMEOUT:
      console.error("User location request timed out.")
...
function validateSearch() {
  if (containsNumbers(document.querySelector(".search-bar").value)) {
    alert("Alphabetical characters only!")
  } else if (containsSpaces(document.querySelector(".search-bar").value)) {
